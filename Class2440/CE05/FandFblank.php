        ...
        <div class="one">
            <div id="container" class="clear">
                ...
                <section id="slider" class="form">
                    ...
                    <form class="two" method="post" action="FandFResults.php" onsubmit="return validateForm()">
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td><input class="myButton" id="Button_Input" type="submit" value="Create" name="requestType"/></td>
                                        </tr>
                                    </table>
                                </td>
                                <td></td>
